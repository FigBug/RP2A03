...
[InstallDelete]
Type: files;          Name: "{commoncf64}\VST\RP2A03.dll";   Components: vst
...
[Files]
Source: "bin\VST\RP2A03.dll";    DestDir: "{commoncf64}\VST";                     Flags: ignoreversion overwritereadonly; Components: vst
