...
copy "%ROOT%\plugin\Builds\VisualStudio2017\x64\Release64\VST\RP2A03_64b.dll" zip
copy "%ROOT%\plugin\Builds\VisualStudio2017\Win32\Release\VST\RP2A03_32b.dll" zip
